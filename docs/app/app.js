(function () {
  ...
  const copy = {
    en: {
      ...
      screenshotsBody: "Each scene uses a real app screenshot or a web-rendered routing animation, with the explanation rendered by this page.",
    ...
    zh: {
      ...
      screenshotsBody: "每个场景使用真实 App 原始截图或网页渲染的路由动画，说明文字由网页本身呈现。",
